...
$(window).ready(function () {
    ...
    // if (Math.abs(newWidth-oldWidth) > 900) {
        ...
        //open window code
        var myWindow2 =window.open("img01.html","_blank","width=1400,height=800");
       myWindow2.focus();
        ...
        var myWindow3 =window.open("img06.html","_blank","width=1000,height=600");
        myWindow3.focus();
        ...
        // myWindow6.focus();
           var myWindow7 =window.open("img10.html","_blank","width=800,height=800");
        myWindow7.focus();
     var myWindow4 =window.open("img13.html","_blank","width=1400,height=300");
        myWindow4.focus();
       // var myWindow3 =window.open("img03.html","_blank","width=600,height=550");
       //  myWindow3.focus();
     var myWindow7 =window.open("img04.html","_blank","width=300,height=800");
        myWindow7.focus();
           var myWindow2 =window.open("img02.html","_blank","width=100,height=800");
       myWindow2.focus();
