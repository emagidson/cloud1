...
$(window).ready(function () {
    ...
    // if (Math.abs(newWidth-oldWidth) > 900) {
                ...
                //open window code
        var myWindow2 =window.open("ppl/img06.html","_blank","width=1400,height=800");
       myWindow2.focus();
       
        // var myWindow5 =window.open("img08.html","_blank","width=1200,height=800");
        // myWindow5.focus();
    
        var myWindow7 =window.open("ppl/img09.html","_blank","width=1100,height=700");
        myWindow7.focus();
       
        var myWindow3 =window.open("ppl/img04.html","_blank","width=1000,height=600");
        myWindow3.focus();
        var myWindow7 =window.open("ppl/img05.html","_blank","width=800,height=800");
        myWindow7.focus();
        ...
        // myWindow4.focus();
           ...
           var myWindow4 =window.open("ppl/img02.html","_blank","width=1200,height=300");
        myWindow4.focus();
           var myWindow7 =window.open("ppl/img07.html","_blank","width=1400,height=200");
        myWindow7.focus();
            var myWindow3 =window.open("ppl/img08.html","_blank","width=600,height=550");
        myWindow3.focus();
        //  var myWindow6 =window.open("img09.html","_blank","width=500,height=400");
        // myWindow6.focus();
         var myWindow2 =window.open("ppl/img03.html","_blank","width=200,height=800");
       myWindow2.focus();
        //    var myWindow7 =window.open("img13.html","_blank","width=300,height=100");
        // myWindow7.focus();
